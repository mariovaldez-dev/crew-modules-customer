...
use App\UI\Http\Middleware\EnsureUserRole;
use App\UI\Http\Middleware\Authenticate;
use App\UI\Http\Middleware\EncryptCookies;
use App\UI\Http\Middleware\PreventRequestsDuringMaintenance;
use App\UI\Http\Middleware\RedirectIfAuthenticated;
...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        // \App\UI\Http\Middleware\TrustHosts::class,
        TrustProxies::class,
        HandleCors::class,
    ...
    protected $routeMiddleware = [
        ...
        'role.operaciones' => EnsureUserRole::class,
    ];
}

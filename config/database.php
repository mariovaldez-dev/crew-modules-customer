    ...
    */
    ...
    'connections' => [
        ...
        'loginDB' => [
            ...
            'port' => env('DB_LOGIN_PORT', '1433'),
            'database' => env('DB_LOGIN_DATABASE', 'forge'),
            'username' => env('DB_LOGIN_USERNAME', 'sa'),
        ...
        'localDB' => [
            'driver' => env('DB_LOCAL_CONNECTION', 'sqlsrv'),
            'host' => env('DB_LOCAL_HOST', '127.0.0.1'),
            'port' => env('DB_LOCAL_PORT', '1433'),
            'database' => env('DB_LOCAL_DATABASE', 'master'),
            'username' => env('DB_LOCAL_USERNAME', 'sa'),

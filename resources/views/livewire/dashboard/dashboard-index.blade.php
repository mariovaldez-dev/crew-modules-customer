<div class="space-y-8 py-4" wire:init="loadData">
    <!-- Header Page -->
    ...
    @if(!$readyToLoad)
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 animate-pulse">
            @for($i = 0; $i < 4; $i++)
                <div class="bg-white dark:bg-[#131B20] border border-gray-100 dark:border-white/5 rounded-3xl p-6 h-36 flex flex-col justify-between shadow-sm">
                    <div class="flex justify-between items-center">
                        <div class="h-3 w-20 bg-gray-200 dark:bg-white/10 rounded-full"></div>
                        <div class="h-4 w-12 bg-gray-200 dark:bg-white/10 rounded-full"></div>
                    </div>
                    <div>
                        <div class="h-8 w-16 bg-gray-200 dark:bg-white/10 rounded-lg mb-2"></div>
                        <div class="h-2 w-24 bg-gray-200 dark:bg-white/10 rounded-full"></div>
                    </div>
                </div>
            @endfor
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-pulse">
            @for($i = 0; $i < 3; $i++)
                <div class="bg-white dark:bg-[#131B20] border border-gray-100/80 dark:border-white/5 rounded-3xl p-6 h-24 flex items-center gap-4 shadow-sm">
                    <div class="w-12 h-12 bg-gray-200 dark:bg-white/10 rounded-2xl shrink-0"></div>
                    <div class="space-y-2 w-full">
                        <div class="h-4 w-3/4 bg-gray-200 dark:bg-white/10 rounded-full"></div>
                        <div class="h-2 w-1/2 bg-gray-200 dark:bg-white/10 rounded-full"></div>
                    </div>
                </div>
            @endfor
        </div>

        <div class="bg-white dark:bg-[#131B20] border border-gray-100 dark:border-white/5 rounded-3xl p-6 shadow-sm animate-pulse space-y-6">
            <div class="h-6 w-48 bg-gray-200 dark:bg-white/10 rounded-lg"></div>
            <div class="space-y-4">
                @for($i = 0; $i < 4; $i++)
                    <div class="flex gap-4">
                        <div class="h-8 w-8 bg-gray-200 dark:bg-white/10 rounded-full shrink-0"></div>
                        <div class="h-8 w-full bg-gray-200 dark:bg-white/10 rounded-lg"></div>
                    </div>
                @endfor
            </div>
        </div>

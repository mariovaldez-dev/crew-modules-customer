...
>
    ...
    <div
        ...
        class="w-full bg-[#F3F5F8] dark:bg-[#0B0F13] rounded-3xl shadow-2xl shadow-black/20 dark:shadow-green-900/10 transform transition-all mx-auto {{ $maxWidthClass }} relative"
    >
        <!-- Header -->
